 ...
 float superpoder2;
        ...
        printf("Super Poder: %.2f\n", superpoder1);
           ...
           printf("\n===Comparação das duas cartas===\n");
                     //população
          int venceuPopulacao1  = (populacao1 > populacao2);
         ...
         int venceuarea = (area1 > area2);
           ...
           int venceuPib = ( pib1 > pib2);
                 ...
                 //Pontos túristicos
            int venceuponto = (turisticos1 > turisticos2);

                 //Densidade 
            int venceudensi = (densidade1 > densidade2);

                //Pib per capta
            int venceucapta = (percapita1 > percapita2);
